...
import { Bot, Video, MessageCircle, Smartphone, CreditCard, HandCoins, Share2, Languages, Power } from "lucide-react";
...
const ICON: Record<OrgFeature, typeof Bot> = {
  ai: Bot, video: Video, whatsapp: MessageCircle, sms: Smartphone, payments: CreditCard, funders: HandCoins, referrals: Share2, language: Languages,
};
