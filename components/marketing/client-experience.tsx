...
const POINTS = [
  ...
  { icon: Sprout, title: "A private space of their own", body: "Their sessions, documents, invoices, messages with their care team, and the next steps their counsellor chooses to share." },
