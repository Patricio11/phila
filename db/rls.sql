...
declare t text;
begin
  foreach t in array array['appointments','audit_log','client_documents','clients','consents','counsellors','funders','grants','invoices','org_members','rooms','services','sites']
  loop
