...
const TEMPLATES: Record<string, { label: string; kind: FormKind; title: string; intro: string; fields: FormField[] }> = {
  ...
  intake_full: {
    ...
    fields: [
      ...
      { id: "preference", label: "Counsellor preference - language and/or religion", type: "text", required: false, help: "e.g. an isiZulu-speaking counsellor, or one who shares your faith. We will do our best to match." },
      { id: "session_mode", label: "How would you like to meet?", type: "radio", required: true, options: ["Online (virtual)", "In person"] },
      ...
      { id: "reason", label: "In your own words, what brings you to counselling?", type: "textarea", required: false, help: "A sentence or two is plenty - only your counsellor reads this." },
