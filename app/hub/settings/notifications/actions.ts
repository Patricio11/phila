...
const templateInput = z.object({
  ...
  key: z.enum(["booked", "rescheduled", "cancelled", "reminder", "no_show"]),
...
const resetInput = z.object({ channel: z.enum(["whatsapp", "sms", "email"]), key: z.enum(["booked", "rescheduled", "cancelled", "reminder", "no_show"]) });
